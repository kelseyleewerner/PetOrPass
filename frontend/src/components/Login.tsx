      ...
      <div className="row justify-content-center align-items-center">
        ...
        <div className="col col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <div className="row align-items-center justify-content-center mt-4">
            <h1 className="display-4 lead fw-normal text-center">
              Pet or Pass
            </h1>
          </div>
          <div className="row align-items-center justify-content-center mt-4">
            <p className="text-center fw-bold">
              Create an account and login to view and rate pets! Will you pet
              them or will you take a pass?
            </p>
          </div>
          <div className="row align-items-center justify-content-center mb-2">
            <p className="text-center">
              Reminder: You must sign up with a functional email address to
              allow password reset if you forget your password
            </p>
          </div>
